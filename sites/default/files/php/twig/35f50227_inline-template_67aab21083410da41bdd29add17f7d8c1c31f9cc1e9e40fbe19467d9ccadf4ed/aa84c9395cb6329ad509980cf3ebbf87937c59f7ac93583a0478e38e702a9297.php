...
/* {# inline_template_start #}<a href="genres/taxonomy/term/{{ tid }}">{{ view_node }} </a> */
class __TwigTemplate_e6821c3c72791baebe398d128036f8074ef5aaa290c99f8a704006c91706a104 extends Twig_Template
{
    ...
    {
        return "{# inline_template_start #}<a href=\"genres/taxonomy/term/{{ tid }}\">{{ view_node }} </a>";
    }
