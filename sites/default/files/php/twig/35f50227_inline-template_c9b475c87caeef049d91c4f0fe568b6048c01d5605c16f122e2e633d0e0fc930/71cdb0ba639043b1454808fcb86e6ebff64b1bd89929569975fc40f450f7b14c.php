...
/* {# inline_template_start #}<a href="http://d8/genres/taxonomy/term/{{ tid }}">{{ view_node }} </a> */
class __TwigTemplate_2c8813d3d9fd83e756fb4a0c7e95a469aa8096fc37b60260f101e10578f308fe extends Twig_Template
{
    ...
    {
        return "{# inline_template_start #}<a href=\"http://d8/genres/taxonomy/term/{{ tid }}\">{{ view_node }} </a>";
    }
